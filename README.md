...
| :---------------------------------------------------------------------------------------------------------------: | :------------------ | :------- | :-------------------------------------------------------------------------------- |
|   <img src="apps/EeveeSpotify.png" width="48" style="border-radius: 22%">    | **EeveeSpotify** | v9.1.22  | Premium Spotify client with lyrics, no ads, and high-quality audio streaming.     |
| <img src="apps/YouTubePlus_5.2b3.PNG" width="48" style="border-radius: 22%"> | **YTLite** | v21.06.2 | Lightweight YouTube tweak with background playback, ad-blocking, and PiP.         |
...
|    <img src="apps/NeoFreeBird.png" width="48" style="border-radius: 22%">    | **NeoFreeBird** | v11.65   | Enhanced X (Twitter) client with ad removal and video downloading capabilities.   |
