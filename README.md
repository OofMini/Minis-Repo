...
|    <img src="apps/NeoFreeBird.png" width="48" style="border-radius: 22%">    | **NeoFreeBird** | v12.5   | Enhanced X (Twitter) client with ad removal and video downloading capabilities.   |
